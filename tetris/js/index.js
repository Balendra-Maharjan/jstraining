...
function SetupCanvas(){
    ...
    // Set font for next tetrimino board and draw
    ctx.fillStyle = 'black';
    ctx.font = '16px Arial';
    ctx.fillText("Next", 300, 30);
    
    // Draw next tetrimino rectangle
    ctx.strokeRect(300, 40, 161, 70);
    
    // Set font for score label text and draw
    ctx.fillStyle = 'black';
    ctx.font = '16px Arial';
    ctx.fillText("SCORE", 300, 140);
    
    // Draw score rectangle
    ctx.strokeRect(300, 152, 161, 24);
    
    // Draw score
    ctx.fillText(score.toString(), 310, 170);
    
    // Draw level label text
    ctx.fillText("LEVEL", 300, 200);
    
    // Draw level rectangle
    ctx.strokeRect(300, 212, 161, 24);
    
    // Draw level
    ctx.fillText(level.toString(), 310, 230);
    
    // Draw next label text
    ctx.fillText("STATUS", 300, 270);
    
    // Draw playing condition
    ctx.fillText(winOrLose, 310, 310);
    
    // Draw playing condition rectangle
    ctx.strokeRect(300, 280, 161, 50);
